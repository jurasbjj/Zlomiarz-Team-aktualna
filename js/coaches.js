...
// text content array
const coachesH1 = ['Daniel Wrześniewski', 'Adam Górny', 'Andrzej Iwat', 'Marcin Soszyński', 'Asia Zabulewicz', 'Michał Miranowski', 'Mateusz Kowalski', 'Marcin Grabowski']
...
const socialPhone = ['607 548 866', '691 839 697', '601 673 076', '791 499 009', 'asia_zabulewicz', '881 456 511', '507 006 766', '884 671 543']
    ...
    //   console.log($('.swiper-slide-active').data().id)
      ...
      // specjalne ustawienia 
       ...
       if($('.swiper-slide-active').data().id === 7){
        $('#coaches .text span.coach-social:nth-of-type(3)').hide()
       }
       else {
        $('#coaches .text span.coach-social:nth-of-type(7)').fadeIn(800)
       }
